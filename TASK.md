...
- 2.9.2 done: cumulative lock criteria, run/layer counters, layer marker support, and lock-gate tests added; py_compile and tuner self-test passed. Commit SHA reported after push.
