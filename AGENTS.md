...
2. **Plan phase** — draft the complete implementation plan in `TASK.md` before
   ...
   ```
   ### firmware/src/main.c
    - Add GET/SET plumbing for JOIN_RATE in protocol.c so reload approach speed is tunable
    - Wire the runtime value through settings_store.c persistence helpers
